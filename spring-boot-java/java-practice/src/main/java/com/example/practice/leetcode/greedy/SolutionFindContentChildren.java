 ...
 * @author fzy
 * @description: easy
 * @date 2024/7/18 13:52
 */
public class SolutionFindContentChildren {
    ...
    public int findContentChildren(int[] child, int[] cookies) {
        ...
        for (int i = child.length - 1; i >= 0; i--) {
            if (start >= 0 && cookies[start] >= child[i]) {
                res++;
                start--;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        SolutionFindContentChildren s = new SolutionFindContentChildren();
        System.out.println(s.findContentChildren(child, cookies));
    }
}
