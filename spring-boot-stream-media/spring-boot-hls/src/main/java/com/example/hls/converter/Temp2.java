...
public class Temp2 {
    ...
    public static void main(String[] args) {
        ...
        String input = "F:\\testData\\mediaTest\\AVI\\AV36_1.AVI";
        String output = "F:\\testData\\mediaTest\\AVI\\Pandas.m3u8";
        try {
            videoConvert(input, output);
        } catch (Exception e) {
    ...
    public static void videoConvert(String inputfile, String outputfile) throws Exception {
        ...
        try {
            ...
            recorder.setOption("hls_segment_filename", "F:\\testData\\mediaTest\\AVI\\Pandas_%03d.ts");
